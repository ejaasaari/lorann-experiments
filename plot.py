...
def create_plot(title, all_data, raw, x_scale, y_scale, xn, yn, fn_out, linestyles, batch):
    ...
    ax.legend(handles, labels, loc="lower left", bbox_to_anchor=(0.01, 0.01), prop={"size": 12})
    plt.grid(visible=True, which="major", color="0.85", linestyle="-")
